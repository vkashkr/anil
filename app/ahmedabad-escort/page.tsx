      ...
      <nav className="p-4 bg-black/50 backdrop-blur-md sticky top-0 z-50 border-b border-white/10">
        <div className="max-w-6xl mx-auto flex flex-col gap-2">
          ...
          <div className="flex flex-wrap items-center gap-1 text-sm text-gray-400">
            ...
            <span className="text-gray-600">&rsaquo;</span><span className="text-gray-300">{profile.country || 'India'}</span>
            <span className="text-gray-600">&rsaquo;</span><span className="text-gray-300">{profile.state || 'Gujarat'}</span>
            <span className="text-gray-600">&rsaquo;</span><span className="text-gray-300">{profile.city || 'Ahmedabad'}</span>
            {profile.place && (
            ...
            <div className="relative aspect-[3/4] w-full rounded-2xl overflow-hidden shadow-2xl border border-white/10 bg-black">
              {selectedImage ? (
                ...
                <div className="w-full h-full flex flex-col items-center justify-center gap-2 text-gray-400">
                  ...
                  <span className="text-sm font-semibold">Contact for photos</span>
                  <span className="text-xs text-gray-600 text-center px-4">Photos shared privately on request</span>
                </div>
              )}
            </div>
