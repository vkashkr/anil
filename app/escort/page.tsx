...
import { getS3ImageUrl } from "./s3Utils";
  ...
  return (
    <div className="min-h-screen w-full bg-zinc-50 font-sans dark:bg-black flex flex-col">
      <div className="w-full bg-pink-100 py-10 flex flex-col items-center">
        <h1 className="text-4xl font-bold text-pink-700 mb-2 text-center">Ahmedabad Escort Services 👄</h1>
        <p className="text-lg text-gray-700 max-w-2xl text-center mb-4">Book Ahmedabad Escorts to Relax & Enjoy Tonight! Fast, safe, and affordable escort services across Ahmedabad. Choose from high-profile, independent, and friendly companions for home or hotel delivery.</p>
      ...
      <div className="flex flex-wrap justify-center gap-8 py-10 px-4">
        {loading ? (
          <div className="text-center text-lg text-gray-500">Loading profiles...</div>
        ) : profiles.length === 0 ? (
          <div className="text-center text-lg text-gray-500">No profiles found.</div>
        ) : (
