          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="/ahmedabad-escort" className="text-gray-400 hover:text-pink-300 transition">Ahmedabad Escort Service</a></li>
                <li><a href="/ahmedabad-escort" className="text-gray-400 hover:text-pink-300 transition">VIP Escorts</a></li>
                <li><a href="/ahmedabad-escort" className="text-gray-400 hover:text-pink-300 transition">New Arrivals</a></li>
