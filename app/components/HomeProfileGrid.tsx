    ...
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden">
        <div className="flex">
          ...
          <a href={`${WHATSAPP_URL}?text=${DEFAULT_WHATSAPP_TEXT}`} target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center justify-center gap-2 py-3.5 bg-gradient-to-r from-green-600 to-teal-600 text-white font-bold text-sm">
